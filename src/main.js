...
const camera = new THREE.PerspectiveCamera(48, innerWidth / innerHeight, 0.1, 220); camera.position.set(58, 88, 62);
...
let focusTarget = new THREE.Vector3(0, 0, 0); let focusCamera = new THREE.Vector3(58, 88, 62);
...
document.querySelector('#reset-view').addEventListener('click', () => { controls.target.set(0, 0, 0); camera.position.set(58, 88, 62); document.querySelector('[data-view="city"]').click(); });
